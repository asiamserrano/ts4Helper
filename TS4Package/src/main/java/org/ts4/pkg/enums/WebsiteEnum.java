...
import org.ts4.pkg.constructors.DomainPath;
import org.ts4.pkg.constructors.SecondLevelDomain;
import org.ts4.pkg.constructors.SubDomain;
import org.ts4.pkg.constructors.TopLevelDomain;

import java.net.URL;

import static org.ts4.pkg.constants.OkHttpConstants.HTTPS_SCHEME;
import static org.ts4.pkg.constructors.DomainPath.*;
import static org.ts4.pkg.constructors.SubDomain.*;
import static org.ts4.pkg.constructors.TopLevelDomain.*;
