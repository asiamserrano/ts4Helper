...
//import org.example.WebsiteModelAvro;
...
//
//@Slf4j @Getter
//public class WebsiteModel extends WebsiteModelAvro {
//
//    private URL url;
////    private String name;
////    private WebsiteModel previous;
//
//    private final WebsiteModelAvro avro;
//
////    public WebsiteModel() {
////        this.url = null;
////        this.avro = new WebsiteModelAvro();
////    }
//
//    public WebsiteModel(WebsiteModelAvro avro) {
//        this.url = URLUtility.createURLNoException(avro.getUrlString());
//        this.avro = avro;
//    }
//
//
...
//        return this.avro.toString();
//    }
//
////    public WebsiteModel(WebsiteModelAvro websiteModelAvro) {
////        super();
////        this.setUrlString(websiteModelAvro.getUrlString());
////        this.setName(websiteModelAvro.getName());
////        this.setPrevious(websiteModelAvro.getPrevious());
////
////    }
//
