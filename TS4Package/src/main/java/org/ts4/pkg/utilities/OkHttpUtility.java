...
import org.ts4.pkg.enums.WebsiteEnum;
//import org.example.ts4package.models.WebsiteModel;

import java.net.URL;

import static org.ts4.pkg.constants.OkHttpConstants.USER_AGENT_HEADER;
import static org.ts4.pkg.constants.OkHttpConstants.USER_AGENT_VALUE;
import static org.ts4.pkg.constants.OkHttpConstants.HTTPS_SCHEME;

import static org.ts4.pkg.constants.StringConstants.FORWARD_SLASH;
