...
import org.example.ts4package.constructors.SecondLevelDomain;
import org.example.ts4package.constructors.SubDomain;
import org.example.ts4package.constructors.TopLevelDomain;

import java.net.URL;

import static org.example.ts4package.constants.OkHttpConstants.HTTPS_SCHEME;
import static org.example.ts4package.constructors.DomainPath.*;
import static org.example.ts4package.constructors.SubDomain.*;
import static org.example.ts4package.constructors.TopLevelDomain.*;
